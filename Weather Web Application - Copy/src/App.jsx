    ...
    <>
      ...
      >
              ...
              <Col>
                <Row>
                  ...
                  <>
                    ...
                    <Row>
                      Weather Desciption: {weatherData.weather[0].description}
                    </Row>
                    ...
                    <Row>Humidity: {weatherData.main.humidity}%</Row>
                    <Row>Wind Speed: {weatherData.wind.speed} m/s</Row>
                    <Row>Pressure: {weatherData.main.pressure} hPa</Row>
                    <Row>
                      Temperature min/max:{" "}
                      {Math.round(weatherData.main.temp_min)}°C/{" "}
                      {weatherData.main.temp_max}°C
                    </Row>
                    <Row>Visibility: {weatherData.visibility / 1000} km</Row>
                  </>
                </Row>
              </Col>
            </Container>
        ...
        <Offcanvas show={show} onHide={handleClose}>
          ...
          <Offcanvas.Body> Weekly Forecast, Weather Warnings</Offcanvas.Body>
        </Offcanvas>
      </Row>{" "}
    </>
  );
